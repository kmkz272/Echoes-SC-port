void Precache()
{
    g_Game.PrecacheModel( "sprites/echoes/logo.spr" );
}
void ShowEchoesLogo( CBaseEntity@ pActivator, CBaseEntity@ pCaller, USE_TYPE useType, float flValue )
{
	HUDSpriteParams params;
	
	params.channel = 4;
	params.flags = HUD_ELEM_SCR_CENTER_X;
	params.spritename = "echoes/logo.spr";
	params.x = 0;
	params.y = 0.48;
	params.frame = 0;
	params.numframes = 1;
