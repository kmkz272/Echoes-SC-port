/** CUSTOM FOOTSTEPS
*
* by Giegue, ** modified by kmkz to adapt to echoes maps and other scripts **
*
...
{
	"echoes/player/pl_step1.ogg",
	"echoes/player/pl_step2.ogg",
	"echoes/player/pl_step3.ogg",
	"echoes/player/pl_step4.ogg"
};

// METAL
const array< string > _MetalSounds =
{
	"echoes/player/pl_metal1.ogg",
	"echoes/player/pl_metal2.ogg",
	"echoes/player/pl_metal3.ogg",
	"echoes/player/pl_metal4.ogg"
};

// DIRT
const array< string > _DirtSounds =
{
	"echoes/player/pl_dirt1.ogg",
	"echoes/player/pl_dirt2.ogg",
	"echoes/player/pl_dirt3.ogg",
	"echoes/player/pl_dirt4.ogg"
};

// VENT
const array< string > _VentSounds =
{
	"echoes/player/pl_duct1.ogg",
	"echoes/player/pl_duct2.ogg",
	"echoes/player/pl_duct3.ogg",
	"echoes/player/pl_duct4.ogg"
};

// GRATE
const array< string > _GrateSounds =
{
	"echoes/player/pl_grate1.ogg",
	"echoes/player/pl_grate2.ogg",
	"echoes/player/pl_grate3.ogg",
	"echoes/player/pl_grate4.ogg"
};

// TILE
const array< string > _TileSounds =
{
	"echoes/player/pl_tile1.ogg",
	"echoes/player/pl_tile2.ogg",
	"echoes/player/pl_tile3.ogg",
	"echoes/player/pl_tile4.ogg"
};
...
{
	"echoes/player/pl_wood1.ogg",
	"echoes/player/pl_wood2.ogg",
	"echoes/player/pl_wood3.ogg",
	"echoes/player/pl_wood4.ogg"
};
...
{
	"echoes/player/pl_ladder1.ogg",
	"echoes/player/pl_ladder2.ogg",
	"echoes/player/pl_ladder3.ogg",
	"echoes/player/pl_ladder4.ogg"
};
...
void FootstepInit()
{
	if (FootstepsAllowed = false) {return;}
