...
> ENSURE HALF-LIFE IS INSTALLED ON STEAM (WINDOWS ONLY)
> (THIS IS NOT COMPATIBLE WITH HALF-LIFE SOURCE)
>
> PLACE THE FOLDER "ECHOES" AND THE FILES "CG.DLL" AND "CGGL.DLL"
> INTO YOUR STEAM HALF-LIFE FOLDER: 
...
TROUBLESHOOTING
This mod is designed only for the current Steam version of Half-Life on Windows.
...
Do not load Half-Life and change to Echoes from within the custom game menu.
